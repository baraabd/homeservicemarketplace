...
// Mutations also CsrfGuard. `userId` taken from @CurrentUser; the
// wire never accepts senderUserId / providerProfileId. Foreign
// conversation surfaces as 404 via the participant gate.
