...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    forgotPasswordDesc: "No worries! Enter your registered email and we'll send you a secure reset link.",
    sendResetLink:      "Send Reset Link",
    checkInbox:         "Check your inbox!",
    sentResetTo:        "We've sent a password reset link to",
    backToLogin:        "Back to Login",
    resendEmail:        "Resend email",
    resetExpiry:        "The reset link expires in 15 minutes. Check your spam folder if you don't see it.",
  ...
  ar: {
    ...
    date:               "التاريخ",
    time:               "الوقت",
    dateValue:          "15 مارس 2026",
    timeValue:          "10:00 صباحاً",
  },
};