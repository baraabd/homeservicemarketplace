  ...
  return (
    <div className="flex items-center justify-between py-3.5 px-4">
      <div className="flex-1 min-w-0 me-4">
        ...
        {sub && (
          <p className="text-slate-400 dark:text-slate-500 mt-0.5" style={{ fontSize: '11px' }}>
            {sub}
          </p>
        )}
      </div>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-4">
      <p
        className="px-4 mb-2 text-slate-400 dark:text-slate-500"
        style={{
          fontSize: '11px',
          fontWeight: 700,
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col items-center text-center gap-3 mb-6">
                ...
                <p className="text-slate-400 dark:text-slate-500" style={{ fontSize: '13px' }}>
                  {L.signOutQ}
                </p>
              </div>
