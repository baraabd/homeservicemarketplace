        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {topPro && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-500 text-white flex-shrink-0" style={{ fontSize: "9px", fontWeight: 700 }}>
          ...
          {showPrice && (
            <div className="flex-shrink-0 text-end">
              <p className="text-slate-900" style={{ fontSize: "20px", fontWeight: 800, lineHeight: "1.1" }}>
                ${price}
              </p>
