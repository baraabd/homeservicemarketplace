export const POLICY_COPY = {
  en: {
    ...
    versionHint: 'Use a unique name such as {version}. Published names cannot be changed.',
    country: 'Country',
  ...
  ar: {
    ...
    version: 'اسم الإصدار',
    versionHint: 'استخدم اسمًا فريدًا مثل {version}. لا يمكن تغيير الاسم بعد النشر.',
    country: 'البلد',
