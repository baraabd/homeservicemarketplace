...
test.describe('provider onboarding v2 — the edit survives', () => {
  ...
  test('BASICS_IDENTITY: a name typed and abandoned in the same second survives everything', async ({
    ...
    await freshPage.goto('/provider/onboarding/BASICS_IDENTITY');
  ...
  test('WORK_AREA: a radius dragged and abandoned survives a reload', async ({ page, context }) => {
  ...
  test('PORTFOLIO: a headline typed and abandoned survives a reload', async ({ page, context }) => {
